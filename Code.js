...
function doGet(e) {
  ...
  if (action === "serve") {
    ...
    t.GEA_PORTAL_ACTION = (portalAction === "reset_password") ? portalAction : "";
  ...
  try {
    ...
    var membersOut = members.map(function(m) {
      ...
      return {
        ...
        country_code_secondary:    m.country_code_secondary || "",
        phone_secondary:           m.phone_secondary || "",
        phone_secondary_whatsapp:  m.phone_secondary_whatsapp || false,
        country_code_emergency:    m.country_code_emergency || "",
        phone_emergency:           m.phone_emergency || "",
        phone_emergency_whatsapp:  m.phone_emergency_whatsapp || false,
...
function generateSampleVariablesForTest(placeholders) {
  ...
  var sampleValues = {
    ...
    'DENIAL_MESSAGE': 'Application does not meet membership criteria.',
    'DENIAL_DATE': dateStr,
    ...
    'INDIVIDUAL_ID': 'IND-' + Math.floor(Math.random() * 100000),
    'RESERVATION_ID': 'RES-' + Math.floor(Math.random() * 100000),
    'CHILD_FIRST_NAME': 'Thomas',
    'BIRTHDAY_DATE': dateStr,
    'RESET_WINDOW_MINUTES': '30',
    'RESET_LINK': 'https://geabotswana.org/reset-password?token=abc123',
    'CARD_ISSUANCE_DATE': dateStr,
    'PHOTO_COUNT': '1',
    'EXPIRATION_DATE': nextWeekStr,
    'EXPIRED_DATE': nextWeekStr,
    'MEMBERSHIP_YEAR': new Date().getFullYear(),
    'MEMBERSHIP_TYPE': 'Full Member',
    'MEMBERSHIP_STATUS': 'Active',
    'RENEWAL_DEADLINE': nextWeekStr,
    'RENEWAL_URL': 'https://geabotswana.org/renew',
    'RENEWAL_PORTAL_URL': 'https://geabotswana.org/renew-portal',
    'DUES_BWP': '2000.00',
    'DUES_USD': '150.00',
    ...
    'REJECTION_DATE': dateStr,
    'RESUBMISSION_DAYS': '7',
    'SUGGESTED_DEADLINE': nextWeekStr,
    ...
    'APPROVED_COUNT': '4',
    'APPROVED_LIST': 'Approved guests',
    'REJECTED_COUNT': '1',
    'REJECTED_LIST': 'Rejected guest',
    'REVIEW_DATE': dateStr,
    ...
    'RSO_CONTACT': 'rso@geabotswana.org',
    'RSO_NEXT_STEPS': 'Await board decision',
